...
(function () {
  ...
  function collect(forCloud) {
    ...
    const data = {
      ...
      pet: JSON.parse(localStorage.getItem("sakura_pet_v3") || localStorage.getItem("sakura_pet_v2") || "null"),
  ...
  function apply(data, mode = "replace") {
    ...
    if ("pet" in data) {
      const petKey = data.pet?.schemaVersion === 3 ? "sakura_pet_v3" : "sakura_pet_v2";
      set(petKey, data.pet);
      if (petKey === "sakura_pet_v3") localStorage.removeItem("sakura_pet_v2");
    }
